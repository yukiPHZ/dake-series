...
送信先、FAX情報、送信内容、送信者情報を入力して、FAX送付状PDFを作成できるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- DakeFAX送付状 の用途に合う単機能ツールを探している人

## 解決する困りごと

送信先と内容を入力してA4縦のFAX送付状PDFを作成します。
...
- 概要: 送信先、FAX情報、送信内容、送信者情報を入力して、FAX送付状PDFを作成できるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: DakeFAX送付状
- 価格案: 500円
- 商品紹介文: 送信先と内容を入力してA4縦のFAX送付状PDFを作成します。
...
- 作品ファイル: booth_ready/DakeFAX_Cover.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_FAX_Cover_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447589

## Store表示用情報

- 商品名: DakeFAX送付状
- キャッチ: 送信先、FAX情報、送信内容、送信者情報を入力して、FAX送付状PDFを作成できるWindows向けアプリです。
- 説明: 送信先と内容を入力してA4縦のFAX送付状PDFを作成します。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_FAX_Cover_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447589
