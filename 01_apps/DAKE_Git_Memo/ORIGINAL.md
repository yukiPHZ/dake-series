...
- 作品ファイル: booth_ready/DakeGit_Memo.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Git_Memo_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447593

## Store表示用情報

- 商品名: DakeGitメモ
- キャッチ: Gitを意識せず、変更履歴を残せるメモアプリです。
- 説明: 書くたびに、変更が残るメモです。
...
- ダウンロード導線: 未確定
- サポート方針: 既存ファイルに記載なし
- Stripe Payment Link: https://buy.stripe.com/aFacN56bL3ZZ3yg7DH0gw07
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Git_Memo_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447593
- BOOTH配布zip: booth_ready/DakeGit_Memo.zip
- Store配布導線: 未確定
