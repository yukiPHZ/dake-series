...
今年が閏年か、固定資産税の評価替え年か、次回評価替え年はいつかを確認できるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dake今年の注意点 の用途に合う単機能ツールを探している人
...
- 概要: 今年が閏年か、固定資産税の評価替え年か、次回評価替え年はいつかを確認できるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
```json
{
  ...
  "release_url": "https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Year_Notice_v1.0.0",
...
- 作品ファイル: booth_ready/DakeYear_Notice.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Year_Notice_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448289

## Store表示用情報

- 商品名: Dake今年の注意点
- キャッチ: 今年が閏年か、固定資産税の評価替え年か、次回評価替え年はいつかを確認できるWindows向けアプリです。
- 説明: 閏年と固定資産税評価替え年を確認します。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/28E7sLas1aonecU5vz0gw0L
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Year_Notice_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448289
