...
このファイルは `DAKE_Price_FixedTax` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: dake_price_fixedtax
- title: Dake固都税計算
- short_title: Dake固都税計算
- category: 計算
- status: available
...
土地評価額と建物評価額から固定資産税・都市計画税の概算年税額を確認できるWindows向けアプリです。
...
- BOOTH紹介文: 固定資産税・都市計画税の概算年税額を計算します。
...
- 概要: 土地評価額と建物評価額から固定資産税・都市計画税の概算年税額を確認できるWindows向けアプリです。
- 使い方: 既存ファイルに記載なし
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakeFixedTax.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Price_FixedTax_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448259

## Store表示用情報

- 商品名: Dake固都税計算
- キャッチ: 土地評価額と建物評価額から固定資産税・都市計画税の概算年税額を確認できるWindows向けアプリです。
- 説明: 固定資産税・都市計画税の概算年税額を計算します。
...
- ダウンロード導線: 未確定
- サポート方針: 既存ファイルに記載なし
- Stripe Payment Link: https://buy.stripe.com/bJefZh9nX7cbfgYgad0gw0E
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Price_FixedTax_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448259
- BOOTH配布zip: booth_ready/DakeFixedTax.zip
- Store配布導線: 未確定
