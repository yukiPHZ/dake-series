...
PDFを追加して保存先を選ぶだけで、各ページをPNG画像として書き出せるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- DakePDFto画像 の用途に合う単機能ツールを探している人
...
- 概要: PDFを追加して保存先を選ぶだけで、各ページをPNG画像として書き出せるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakePDF_to_Images.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_ToImages_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448216

## Store表示用情報

- 商品名: DakePDFto画像
- キャッチ: PDFを追加して保存先を選ぶだけで、各ページをPNG画像として書き出せるWindows向けアプリです。
- 説明: PDFの各ページをPNG画像に変換します。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_ToImages_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448216
