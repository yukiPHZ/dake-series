...
ダイバーが海へ潜り、捕った獲物を船へ戻して得点する軽量ミニゲームです。
...
- 概要: ダイバーが海へ潜り、捕った獲物を船へ戻して得点する軽量ミニゲームです。
- 使い方: 既存ファイルに記載なし
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakeGame_Diver_Catch.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Game_Diver_Catch_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8449218

## Store表示用情報

- 商品名: Dake潜って捕る
- キャッチ: ダイバーが海へ潜り、捕った獲物を船へ戻して得点する軽量ミニゲームです。
- 説明: 潜って捕って、船へ戻るレトロ風ミニゲーム。
...
- ダウンロード導線: 未確定
- サポート方針: 既存ファイルに記載なし
- Stripe Payment Link: https://buy.stripe.com/dRm5kD43DeED6Ks3nr0gw0N
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Game_Diver_Catch_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8449218
- BOOTH配布zip: booth_ready/DakeGame_Diver_Catch.zip
- Store配布導線: 未確定
