...
PDFに赤い丸や矢印を付けて、確認してほしい箇所を伝えられるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- DakePDFここ見て の用途に合う単機能ツールを探している人
...
- 概要: PDFに赤い丸や矢印を付けて、確認してほしい箇所を伝えられるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
```json
{
  ...
  "release_url": "https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_LookHere_v1.0.0",
...
- 作品ファイル: booth_ready/DakePDF_LookHere.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_LookHere_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448187

## Store表示用情報

- 商品名: DakePDFここ見て
- キャッチ: PDFに赤い丸や矢印を付けて、確認してほしい箇所を伝えられるWindows向けアプリです。
- 説明: PDFに赤い丸と矢印を付けます。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_LookHere_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448187
