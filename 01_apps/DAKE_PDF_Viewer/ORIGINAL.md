...
フォルダ内PDFの一覧表示、ページ確認、拡大縮小に絞った軽量PDFビューワーです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- DakePDF見る の用途に合う単機能ツールを探している人

## 解決する困りごと

PDFを探してすぐ確認する軽量ビューワーです。
...
- 概要: フォルダ内PDFの一覧表示、ページ確認、拡大縮小に絞った軽量PDFビューワーです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
```json
{
  ...
  "release_url": "https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_Viewer_v1.0.0",
...
- 作品ファイル: booth_ready/DakePDF_Viewer.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_Viewer_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448219

## Store表示用情報

- 商品名: DakePDF見る
- キャッチ: フォルダ内PDFの一覧表示、ページ確認、拡大縮小に絞った軽量PDFビューワーです。
- 説明: PDFを探してすぐ確認する軽量ビューワーです。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_Viewer_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448219
