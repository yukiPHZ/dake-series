...
宛先、送付内容、作成者情報を入力して、A4縦の書類送付状PDFを作成できるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dake書類送付状 の用途に合う単機能ツールを探している人

## 解決する困りごと

相手方と本文を入力してA4送付状PDFを作成します。
...
- 概要: 宛先、送付内容、作成者情報を入力して、A4縦の書類送付状PDFを作成できるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: Dake書類送付状
- 価格案: 500円
- 商品紹介文: 相手方と本文を入力してA4送付状PDFを作成します。
...
- 作品ファイル: booth_ready/DakeDocument_Cover.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Document_Cover-v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447586

## Store表示用情報

- 商品名: Dake書類送付状
- キャッチ: 宛先、送付内容、作成者情報を入力して、A4縦の書類送付状PDFを作成できるWindows向けアプリです。
- 説明: 相手方と本文を入力してA4送付状PDFを作成します。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/fZubJ12Zzbsrd8Q3nr0gw0g
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Document_Cover-v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447586
