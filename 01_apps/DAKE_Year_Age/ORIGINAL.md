...
築年を入力するだけで、現在年基準の築年数を西暦・和暦どちらからでも確認できるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dake築年数 の用途に合う単機能ツールを探している人
...
- 概要: 築年を入力するだけで、現在年基準の築年数を西暦・和暦どちらからでも確認できるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakeYear_Age.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Year_Age_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448286

## Store表示用情報

- 商品名: Dake築年数
- キャッチ: 築年を入力するだけで、現在年基準の築年数を西暦・和暦どちらからでも確認できるWindows向けアプリです。
- 説明: 西暦・和暦から築年数を確認します。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/3cIfZh6bL2VV5Go9LP0gw0K
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Year_Age_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448286
