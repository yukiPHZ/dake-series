...
どこに置いたか忘れたDAKE系アプリを探して、起動やフォルダ表示まで行う探索アプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- アプリどこ の用途に合う単機能ツールを探している人

## 解決する困りごと

PC内に散らばったDAKE系アプリを探します。
...
- 概要: どこに置いたか忘れたDAKE系アプリを探して、起動やフォルダ表示まで行う探索アプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakeApp_Doko.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_App_Doko_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447573

## Store表示用情報

- 商品名: アプリどこ
- キャッチ: どこに置いたか忘れたDAKE系アプリを探して、起動やフォルダ表示まで行う探索アプリです。
- 説明: PC内に散らばったDAKE系アプリを探します。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_App_Doko_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447573
