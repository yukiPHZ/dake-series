...
このファイルは `DAKE_Mail_Address_Format` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: `DAKE_Mail_Address_Format`
- title: Dakeメールアドレス整形
- short_title: Dakeメールアドレス整形
- category: メール
- status: available
...
名前付き表記、改行、セミコロン混在のメールアドレスをまとめて整形します。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dakeメールアドレス整形 の用途に合う単機能ツールを探している人

## 解決する困りごと

貼り付けたメールアドレスを、カンマ区切りに整えます。
...
- 概要: 名前付き表記、改行、セミコロン混在のメールアドレスをまとめて整形します。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: Dakeメールアドレス整形
- 価格案: 300円
- 商品紹介文: 貼り付けたメールアドレスを、カンマ区切りに整えます。
...
- 作品ファイル: booth_ready/DakeMail_Address_Format.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Mail_Address_Format_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447996

## Store表示用情報

- 商品名: Dakeメールアドレス整形
- キャッチ: 名前付き表記、改行、セミコロン混在のメールアドレスをまとめて整形します。
- 説明: 貼り付けたメールアドレスを、カンマ区切りに整えます。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/fZu3cvbw57cbc4Mf690gw09
...
- exe: DakeMail_Address_Format.exe
- README.txt: あり
- 注意事項.txt: あり
