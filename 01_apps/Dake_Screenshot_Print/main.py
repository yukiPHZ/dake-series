...
UI_TEXT = {
    ...
    "empty_subtitle": "Win + Shift + S のあと、クリップボードから取得してください。",
    "error_title": "エラー",
...
STATUS_THEME = {
    ...
    "status_printing": (THEME["selection_bg"], THEME["accent"]),
...
class ScreenshotPrintApp:
    ...
    def _build_ui(self) -> None:
        ...
        self.clipboard_button = ttk.Button(
            actions,
            text=UI_TEXT["button_get_clipboard"],
    ...
    def _build_footer(self, container: tk.Frame) -> None:
        ...
        self._make_footer_text(self.footer_left, UI_TEXT["footer_left_separator"])
        self._make_footer_text(self.footer_left, UI_TEXT["footer_subtitle"])
    ...
    def _update_footer_layout(self, _event=None) -> None:
        compact = self.root.winfo_width() < 820
