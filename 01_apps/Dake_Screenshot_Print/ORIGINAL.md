...
Win + Shift + Sで切り取った画像をクリップボードから取得し、A4縦プレビューで印刷できるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dakeスクショ印刷 の用途に合う単機能ツールを探している人

## 解決する困りごと

クリップボードのスクリーンショットをA4縦で印刷します。
...
- 概要: Win + Shift + Sで切り取った画像をクリップボードから取得し、A4縦プレビューで印刷できるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: Dakeスクショ印刷
- 価格案: 500円
- 商品紹介文: クリップボードのスクリーンショットをA4縦で印刷します。
...
- 作品ファイル: booth_ready/DakeScreenshot_Print.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Screenshot_Print_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448262

## Store表示用情報

- 商品名: Dakeスクショ印刷
- キャッチ: Win + Shift + Sで切り取った画像をクリップボードから取得し、A4縦プレビューで印刷できるWindows向けアプリです。
- 説明: クリップボードのスクリーンショットをA4縦で印刷します。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Screenshot_Print_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448262
