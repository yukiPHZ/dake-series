...
LOG_TEXT = {
    ...
    "horizontal_video_start": "補助脳：横動画を書き出しています。",
    "horizontal_video_layout": "補助脳：1920x1080に整えています。",
    "horizontal_video_nvenc": "補助脳：NVENCで通常動画を書き出しています。",
    "horizontal_video_created": "補助脳：横動画が出せる形になりました。",
    "horizontal_video_fallback": "補助脳：NVENCで試しましたが、CPUへ切り替えました。",
    "horizontal_video_failed": "補助脳：横動画の書き出しに失敗しました。",
    "shorts_pack_start": "補助脳：Shorts Pack を整えています。",
    "shorts_pack_roles": "補助脳：導入・作業・余熱へ分けています。",
    "shorts_pack_flow": "補助脳：静かな流れを整えています。",
    "shorts_pack_bgm": "補助脳：BGMを小さく添えています。",
    "shorts_pack_created": "補助脳：Shorts Pack を作成しました。",
    "shorts_pack_failed": "補助脳：Shorts Pack の生成に失敗しました。",
    "smart_horizontal_start": "補助脳：良い区間を整理しています。",
    "smart_horizontal_flow": "補助脳：静かな流れを構成しています。",
    "smart_horizontal_export": "補助脳：横編集版を書き出しています。",
    "smart_horizontal_bgm": "補助脳：BGMを小さく添えています。",
    "smart_horizontal_created": "補助脳：Smart Horizontal Edit を作成しました。",
    "smart_horizontal_failed": "補助脳：Smart Horizontal Edit の生成に失敗しました。",
    "upload_package_start": "補助脳：投稿前セットを整えています。",
    "upload_package_assets": "補助脳：Shortsと横動画をまとめています。",
    "upload_package_metadata": "補助脳：metadataを整えています。",
    "upload_package_ready": "補助脳：YouTubeへ持っていける形にしました。",
    "upload_package_failed": "補助脳：Upload Package の生成に失敗しました。",
    "thumbnail_flow_start": "補助脳：サムネ候補を整理しています。",
    "thumbnail_flow_search": "補助脳：静かな導入向きの画を探しています。",
    "thumbnail_flow_ready": "補助脳：サムネ候補を出力しました。",
    "thumbnail_flow_added": "補助脳：サムネを投稿前セットへ追加しました。",
    "thumbnail_flow_failed": "補助脳：サムネ候補の生成に失敗しました。",
    "title_match_start": "補助脳：サムネとタイトルの相性を整理しています。",
    "title_match_ready": "補助脳：入口セットを作成しました。",
    "title_match_added": "補助脳：入口セットを投稿前セットへ追加しました。",
    "title_match_failed": "補助脳：Title Match の生成に失敗しました。",
    "final_polish_start": "補助脳：投稿前の最終確認を整えています。",
    "final_polish_upload": "補助脳：Upload Ready を確認しています。",
    "final_polish_preview": "補助脳：プレビューウォールを整えています。",
    "final_polish_ready": "補助脳：出したくなる状態に整えました。",
    "final_polish_failed": "補助脳：Final Polish の生成に失敗しました。",
