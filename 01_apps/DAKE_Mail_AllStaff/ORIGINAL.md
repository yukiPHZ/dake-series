...
全社員宛メールの新規作成画面を、TO、CC、件名が入った状態で既定メーラーに開くWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dake全社員メール起動 の用途に合う単機能ツールを探している人

## 解決する困りごと

宛先、CC、件名入りの全社員宛メール作成画面を開きます。
...
- メール送信の有無: 要確認（既存ファイルから断定しない）
- 下書き作成: 既存ファイルに記載がある場合のみ派生ビューへ反映する
- 宛先データの扱い: 既存ファイルに記載なし
- 自動送信しない理由: 要確認
- 注意: 送信機能の追加は別途仕様確認が必要
...
- 概要: 全社員宛メールの新規作成画面を、TO、CC、件名が入った状態で既定メーラーに開くWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: Dake全社員メール起動
- 価格案: 300円
- 商品紹介文: 宛先、CC、件名入りの全社員宛メール作成画面を開きます。
...
- 作品ファイル: booth_ready/Dake_AllStaff_Mail.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Mail_AllStaff_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447998

## Store表示用情報

- 商品名: Dake全社員メール起動
- キャッチ: 全社員宛メールの新規作成画面を、TO、CC、件名が入った状態で既定メーラーに開くWindows向けアプリです。
- 説明: 宛先、CC、件名入りの全社員宛メール作成画面を開きます。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/5kQ9ATgQp0NN5Go6zD0gw0o
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Mail_AllStaff_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447998
