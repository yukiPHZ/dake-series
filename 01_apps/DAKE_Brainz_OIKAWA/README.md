...
OIKAWAはv0.2で、QPSCの前面UIとして「探して、戻って、読む」場所から、必要な記憶が静かに側へ戻ってくる場所へ進みました。判断代行はせず、原本へ戻れる入口を置きます。

- QPSC状態確認でBRAINZ / OIKAWA連携を軽く確認できます
...
## QPSC Patch: OIKAWAフッター最小化 / 空説明削減

- フッターは `QPSC — Quiet Personal Cognitive System by Yukihiko Kikuta` のみを表示します。
- OIKAWAは思想を語るUIではなく、記憶が浮く端末として扱います。
- 側に在る / 巡回 / 静かだった記憶 / 熱補助は、候補がある時だけ静かに表示します。
- 空状態は大きく説明せず、正本ニュースと熾火を中心にします。

## QPSC Patch: OIKAWA宇宙感強化 / カード透過風
