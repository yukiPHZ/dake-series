...
DAKEアプリのBOOTH登録作業を、商品情報の確認と開いているBOOTH編集画面への入力補助で止まらず進めるためのアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- BOOTHアシスト の用途に合う単機能ツールを探している人

## 解決する困りごと

BOOTH登録に必要な商品情報と素材を確認し、開いているBOOTH編集画面への入力作業を補助します。
...
- 概要: DAKEアプリのBOOTH登録作業を、商品情報の確認と開いているBOOTH編集画面への入力補助で止まらず進めるためのアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: DakeBOOTHアシスト
- 価格案: 300円
- 商品紹介文: BOOTH登録に必要な商品情報と素材を確認し、開いているBOOTH編集画面への入力作業を補助します。
...
- 作品ファイル: booth_ready/DakeBOOTH_Assist.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_BOOTH_Assist_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447580

## Store表示用情報

- 商品名: BOOTHアシスト
- キャッチ: DAKEアプリのBOOTH登録作業を、商品情報の確認と開いているBOOTH編集画面への入力補助で止まらず進めるためのアプリです。
- 説明: BOOTH登録に必要な商品情報と素材を確認し、開いているBOOTH編集画面への入力作業を補助します。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_BOOTH_Assist_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447580
