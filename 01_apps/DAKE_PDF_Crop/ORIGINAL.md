...
PDFプレビュー上で残したい範囲をドラッグし、トリミング済みPDFとして保存できるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- DakePDFトリミング の用途に合う単機能ツールを探している人

## 解決する困りごと

PDFをドラッグ指定した範囲でトリミングします。
...
- 概要: PDFプレビュー上で残したい範囲をドラッグし、トリミング済みPDFとして保存できるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakePDF_Crop.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_Crop_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448182

## Store表示用情報

- 商品名: DakePDFトリミング
- キャッチ: PDFプレビュー上で残したい範囲をドラッグし、トリミング済みPDFとして保存できるWindows向けアプリです。
- 説明: PDFをドラッグ指定した範囲でトリミングします。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_PDF_Crop_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448182
