...
このファイルは `DAKE_TwoPerson_Memo` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: `dake_two_person_memo`
- title: Dake二人メモ
- short_title: Dake二人メモ
- category: メモ
- status: available
...
右の人、左の人。互いのメモを奪わず、確認だけ返せる共同メモです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dake二人メモ の用途に合う単機能ツールを探している人
...
- 概要: 右の人、左の人。互いのメモを奪わず、確認だけ返せる共同メモです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakeTwoPerson_Memo.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_TwoPerson_Memo_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448279

## Store表示用情報

- 商品名: Dake二人メモ
- キャッチ: 右の人、左の人。互いのメモを奪わず、確認だけ返せる共同メモです。
- 説明: 2人で使う、ぶつからない共同メモ。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/28EeVdas1eED1q8e250gw0I
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_TwoPerson_Memo_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448279
