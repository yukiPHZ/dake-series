...
このファイルは `DAKE_Image_HEICtoJPG` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: dake_image_heictojpg
- title: HEIC→JPG変換
- short_title: HEIC→JPG変換
- category: 画像
- status: available
...
HEIC画像やフォルダを追加して、元画像と同じ場所へJPGを書き出せるWindows向けアプリです。
...
- 概要: HEIC画像やフォルダを追加して、元画像と同じ場所へJPGを書き出せるWindows向けアプリです。
- 使い方: 既存ファイルに記載なし
- 必要なもの: Windows環境
...
```json
{
  ...
  "release_url": "https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Image_HEICtoJPG_v1.0.0",
...
- 作品ファイル: booth_ready/DakeHEIC_JPG.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Image_HEICtoJPG_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447596

## Store表示用情報

- 商品名: HEIC→JPG変換
- キャッチ: HEIC画像やフォルダを追加して、元画像と同じ場所へJPGを書き出せるWindows向けアプリです。
- 説明: HEIC画像をJPGへ変換します。
...
- ダウンロード導線: 未確定
- サポート方針: 既存ファイルに記載なし
- Stripe Payment Link: https://buy.stripe.com/4gMfZhas1gML4CkaPT0gw0j
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Image_HEICtoJPG_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447596
- BOOTH配布zip: booth_ready/DakeHEIC_JPG.zip
- Store配布導線: 未確定
