...
DAKEシリーズ各アプリを迷わず1クリックで起動する入口アプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dakeランチャー の用途に合う単機能ツールを探している人
...
- 概要: DAKEシリーズ各アプリを迷わず1クリックで起動する入口アプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: Dakeランチャー
- 価格案: 300円
- 商品紹介文: DAKEシリーズ各アプリを1クリックで起動します。
...
- 作品ファイル: booth_ready/Dake_Launcher.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Launcher_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447994

## Store表示用情報

- 商品名: Dakeランチャー
- キャッチ: DAKEシリーズ各アプリを迷わず1クリックで起動する入口アプリです。
- 説明: DAKEシリーズ各アプリを1クリックで起動します。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Launcher_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447994
- dakeapp.com: show_on_site=true
- Launcher: show_in_launcher=false
- Store: 未確定
