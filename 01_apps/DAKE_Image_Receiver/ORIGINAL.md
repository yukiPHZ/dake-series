...
このファイルは `DAKE_Image_Receiver` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: `dake_image_receiver`
- title: DakeImage_Receiver
- short_title: スマホ画像受信
- category: 画像
- status: available
...
PCに表示したQRコードをスマホで読み取り、画像をWindows PCへ送るための受信アプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- DakeImage_Receiver の用途に合う単機能ツールを探している人
...
- 概要: PCに表示したQRコードをスマホで読み取り、画像をWindows PCへ送るための受信アプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: DakeImage_Receiver
- 価格案: 500円
- 商品紹介文: スマホから画像をこのPCへ送ります。
...
- 作品ファイル: booth_ready/DakeImage_Receiver.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Image_Receiver_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447600

## Store表示用情報

- 商品名: DakeImage_Receiver
- キャッチ: PCに表示したQRコードをスマホで読み取り、画像をWindows PCへ送るための受信アプリです。
- 説明: スマホから画像をこのPCへ送ります。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Image_Receiver_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447600
