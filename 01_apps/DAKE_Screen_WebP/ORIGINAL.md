...
このファイルは `DAKE_Screen_WebP` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: `dake_screen_webp`
- title: DakeScreen_WebP
- short_title: スクショ→WebP
- category: スクリーンショット
- status: available
...
現在アクティブなウインドウだけを撮影し、横幅1200px以内のWebPとして保存できるWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- DakeScreen_WebP の用途に合う単機能ツールを探している人
...
- 概要: 現在アクティブなウインドウだけを撮影し、横幅1200px以内のWebPとして保存できるWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
```json
{
  ...
  "release_url": "https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Screen_WebP_v1.0.0",
...
- 作品ファイル: booth_ready/DakeScreen_WebP.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Screen_WebP_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448261

## Store表示用情報

- 商品名: DakeScreen_WebP
- キャッチ: 現在アクティブなウインドウだけを撮影し、横幅1200px以内のWebPとして保存できるWindows向けアプリです。
- 説明: 選んだウインドウをWebPで保存します。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/3cIaEXas1cwv0m49LP0gw0G
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Screen_WebP_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448261
