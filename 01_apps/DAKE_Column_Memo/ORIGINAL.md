...
長くなったメモを、列に流して見渡せる単機能メモです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- ずっとメモ の用途に合う単機能ツールを探している人
...
```json
{
  ...
  "release_url": "https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Column_Memo_v1.0.0",
...
- 作品ファイル: booth_ready/DakeColumn_Memo.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Column_Memo_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447582

## Store表示用情報

- 商品名: ずっとメモ
- キャッチ: 長くなったメモを、列に流して見渡せる単機能メモです。
- 説明: 1本のメモを、列に流して見渡します。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/7sY6oHbw5gMLc4M4rv0gw0f
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Column_Memo_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447582
