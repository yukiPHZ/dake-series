...
このファイルは `DAKE_Image_iPhoneToPC` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: `dake_image_iphonetopc`
- title: Dake画像iPhoneToPC
- short_title: iPhone画像受信
- category: 画像
- status: available
...
PC画面のQRコードをiPhoneで読み取り、同じWi-Fi上で写真をWindows PCへ送れるアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dake画像iPhoneToPC の用途に合う単機能ツールを探している人

## 解決する困りごと

QRコード経由でiPhone写真をPCへ送ります。
...
- 概要: PC画面のQRコードをiPhoneで読み取り、同じWi-Fi上で写真をWindows PCへ送れるアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 商品名: Dake画像iPhoneToPC
- 価格案: 500円
- 商品紹介文: QRコード経由でiPhone写真をPCへ送ります。
...
- 作品ファイル: booth_ready/DakeImage_iPhoneToPC.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Image_iPhoneToPC_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8447598

## Store表示用情報

- 商品名: Dake画像iPhoneToPC
- キャッチ: PC画面のQRコードをiPhoneで読み取り、同じWi-Fi上で写真をWindows PCへ送れるアプリです。
- 説明: QRコード経由でiPhone写真をPCへ送ります。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/cNicN5fMlgML9WE1fj0gw0k
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Image_iPhoneToPC_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8447598
