...
保存しない。でも前回の続きはそのまま残る、実務用メモアプリです。
...
- BOOTH紹介文: 保存を気にせず、今の考えをそのまま置いておくメモです。
...
- 概要: 保存しない。でも前回の続きはそのまま残る、実務用メモアプリです。
- 使い方: 既存ファイルに記載なし
- 必要なもの: Windows環境
...
- 商品名: Dakeマジでメモ
- 価格案: 300円
- 商品紹介文: 保存を気にせず、今の考えをそのまま置いておくメモです。
...
- 作品ファイル: booth_ready/DakeMaji_Memo.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Maji_Memo_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448021

## Store表示用情報

- 商品名: マジでメモ
- キャッチ: 保存しない。でも前回の続きはそのまま残る、実務用メモアプリです。
- 説明: 保存を気にせず、今の考えをそのまま置いておくメモです。
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Maji_Memo_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448021
- BOOTH配布zip: booth_ready/DakeMaji_Memo.zip
- Store配布導線: 未確定
