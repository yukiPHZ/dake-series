...
件名と本文を入力して、菊田宛の新規メール作成画面を既定メーラーで開くWindows向けアプリです。

## 対象ユーザー

- Windowsで小さな実務作業を短く終わらせたい人
- Dake菊田メール の用途に合う単機能ツールを探している人
...
- 概要: 件名と本文を入力して、菊田宛の新規メール作成画面を既定メーラーで開くWindows向けアプリです。
- 使い方: 既存READMEを暫定参照
- 必要なもの: Windows環境
...
- 作品ファイル: booth_ready/DakeKikuta_Mail.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Mail_Kikuta_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448003

## Store表示用情報

- 商品名: Dake菊田メール
- キャッチ: 件名と本文を入力して、菊田宛の新規メール作成画面を既定メーラーで開くWindows向けアプリです。
- 説明: 菊田宛のメール作成画面を開きます。
...
- ダウンロード導線: 未確定
- サポート方針: 未確定
- Stripe Payment Link: https://buy.stripe.com/4gM9ATas1cwvc4M4rv0gw0p
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Mail_Kikuta_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448003
