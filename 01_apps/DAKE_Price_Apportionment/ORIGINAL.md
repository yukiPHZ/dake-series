...
このファイルは `DAKE_Price_Apportionment` の真の正本です。

README.md、DAKE_META、release_body.md、booth_product.txt、Store表示などは、このファイルから派生するビューです。

## 基本情報

- app_id: dake_price_apportionment
- title: Dake価格按分
- short_title: Dake価格按分
- category: 計算
- status: available
...
不動産売買価格を土地・建物の評価額比率で参考按分し、転記しやすい結果を表示するWindows向けアプリです。
...
- BOOTH紹介文: 売買価格を土地・建物評価額比率で参考按分します。
...
- 概要: 不動産売買価格を土地・建物の評価額比率で参考按分し、転記しやすい結果を表示するWindows向けアプリです。
- 使い方: 既存ファイルに記載なし
- 必要なもの: Windows環境
...
```json
{
  ...
  "release_url": "https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Price_Apportionment_v1.0.0",
...
- 作品ファイル: booth_ready/DakePrice_Apportionment.zip
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Price_Apportionment_v1.0.0
- BOOTH URL: https://peakheadz.booth.pm/items/8448222

## Store表示用情報

- 商品名: Dake価格按分
- キャッチ: 不動産売買価格を土地・建物の評価額比率で参考按分し、転記しやすい結果を表示するWindows向けアプリです。
- 説明: 売買価格を土地・建物評価額比率で参考按分します。
...
- ダウンロード導線: 未確定
- サポート方針: 既存ファイルに記載なし
- Stripe Payment Link: https://buy.stripe.com/dRm3cvcA9543d8QcY10gw0D
...
- GitHub Release: https://github.com/yukiPHZ/dake-series/releases/tag/DAKE_Price_Apportionment_v1.0.0
- BOOTH: https://peakheadz.booth.pm/items/8448222
- BOOTH配布zip: booth_ready/DakePrice_Apportionment.zip
- Store配布導線: 未確定
...
- exe: DakePrice_Apportionment.exe
